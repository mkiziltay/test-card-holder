  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Add Card Informations'),
      ),
                    ...
                    onPressed: () {
                      if (formKey.currentState!.validate()) {
                        ...
                        myController.addCard(
                            card: CardInfo(
                                id: myController.getBox().values.length,
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(new SnackBar(
                          content: Text('Warning : inValid Information'),
                          ...
                          margin:
                              EdgeInsets.only(bottom: 50, right: 20, left: 20),
                        ));
                      }
                    },
                  )
